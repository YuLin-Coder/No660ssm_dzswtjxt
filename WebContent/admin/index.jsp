...
<body>
	...
	<div class="loginWraper">
		<div id="loginform" class="loginBox">
			<form class="form form-horizontal" action="admin/login.action" name="myform" method="post" onSubmit="return checkLogin()">
				<p style="font-size: 28px;font-weight: bold;text-align: center;color: white;letter-spacing: 2px;margin-bottom: 30px;">电子商务推荐系统</p>
				<div class="row cl">
	...
	<div class="footer">版权所有 &copy; All Rights Reserved</div>
</body>
</html>
