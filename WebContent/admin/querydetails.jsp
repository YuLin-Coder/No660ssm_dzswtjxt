...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>订单明细管理 <span class="c-gray en">&gt;</span> 订单明细查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="5">订单明细查询</th>
				</tr>
				<tr class="text-c">
			...
			<c:forEach items="${detailsList}" var="details">
				<tr class="text-c">
					<td class="center">${details.ordercode}</td>
